...
//
// For a uniform field H = (0, H₀):
//   - At the top pole (n ∥ H):  F_m = -(1/2)H₀²∇χ  (pointing inward, compresses)
//   - At the side equator (n ⟂ H): F_m = -(1/2)H₀²∇χ  (pointing outward, expands)
//   → Net effect: bubble compresses in the field direction (opposite of full Maxwell)
template <typename PFCELL, typename MFCELL, typename NSCELL>
