...
//    PSI, OMEGA_PSI, MU_PERCELL, CHI_PERCELL, HX, HY, HZ, HMAG
...
struct HMagBase        : public FieldBase<1> {};  // |H| = sqrt(H_x² + H_y² + H_z²)
...
struct H0Base     : public FieldBase<1> {};  // 外加磁场强度 H₀ (沿 z 方向)
struct PsiKBase    : public FieldBase<1> {};  // ψ 求解器松弛系数 K: τ_ψ = 0.5 + K·μ
...
// MF2: H = -∇ψ via D3Q7 6-direction isotropic gradient
