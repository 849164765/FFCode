...
| 8500 | **1.0851** | 1.0102 | 1.0102      | —               |
| 9000 | **1.0851** | 0.9900† | 1.0102      | —               |
| 9500 | **1.0729** | **0.9800‡** | **0.9800‡** | —               |
| 12000 | **1.0417** | 0.8942 | 0.9314      | —               |
| 13500 | **0.9898** | 0.8654 | 0.8654      | —               |
| **15000** | **0.9500** | **0.8208** | **0.8208** | —               |

### 最终结果（t=15000, t*≈1.03）

| 公式 | elong | Dx | Dy | Henh | 磁力效应 |
|------|-------|-----|-----|------|----------|
| **Maxwell** | **0.9500** | 100 | 95 | 1.3088 | ✅ +15.7% vs Paper |
| Paper | 0.8208 | 106 | 87 | 1.3382 | ❌ 无（仅浮力） |
| Interfacial | 0.8208 | 106 | 87 | 1.3378 | ❌ 无（== Paper） |

**最终结论**：
1. Maxwell 气泡比 Paper 气泡少变形 15.7%（0.9500 vs 0.8208）
2. 磁力显著抵抗了浮力导致的水平变扁
3. Paper ≡ Interfacial 在所有时间步完全一致（数学等价性确认）
4. Henh: Paper/Interfacial 达到 1.338（101% 期望值），Maxwell 为 1.309（98%）

† Paper 短暂偏离 Interfacial（数值噪声），t=9500 恢复一致
‡ Paper/Interfacial 气泡变为**水平椭圆形**（Dx=100 > Dy=98，oblate）
   这是 Eo=20 下浮力主导的预期行为——气泡上升时变扁
   Maxwell 气泡保持**垂直拉长**（Dx=96 < Dy=103，prolate）
   → 磁力 vs 浮力的方向性差异清晰可见
