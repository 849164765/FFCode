...
int main(int argc, char* argv[]) {
  ...
  Printer::Print_BigBanner(std::string("Initializing Simple 2D Droplet Simulation (MRT)..."));
  ...
  vtmo::vtmWriter<T, 2> MainWriter("simpledrop2dMRT", Geo);
  ...
  Printer::Print_BigBanner(std::string("Start Simple 2D Droplet Simulation (MRT)..."));
