...
int main(int argc, char* argv[]) {
  ...
  // Use Converter to compute all lattice parameters
  T sigma_lat = T(0.072);  // surface tension in lattice units
  ...
  // Set globals from Converter (used by ff2d functors)
